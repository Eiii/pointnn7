...
def single(base, net_path, norm):
    ...
    for sensor_id in all_ids:
        ...
        plot_preds(ax, ds, preds, sensor_idx, norm_info, 'tpc')
        ax.legend()
...
if __name__ == '__main__':
    ...
    single(args.data, args.net, args.normalize)
